...
//
//  Note: Example 7 - http://shell-storm.org/blog/Taint-analysis-with-Pin/
//        Detect a format string vulnerability
//
...
VOID callbackBeforePrintf(ADDRINT rdi)
{
  std::string content = new std::string(rdi);
}
...
VOID Image(IMG img, VOID *v)
{
  ...
  if (RTN_Valid(printfRtn)){
    ...
    RTN_InsertCall(
        printfRtn, 
        IPOINT_BEFORE, (AFUNPTR)callbackBeforePrintf,
